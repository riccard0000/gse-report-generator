...
function AppInner() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <aside
        className={`
          fixed top-0 left-0 h-full z-30 bg-white border-r border-slate-200 shadow-lg
        ...
        <nav className="flex-1 py-3 px-2 flex flex-col gap-1">
          {navItems.map((item) => (
            <button
              ...
              className={`
                flex items-center gap-3 rounded-lg px-2 py-2.5 w-full text-left transition-colors
                ${page === item.id
        ...
        <header className="bg-white border-b border-slate-200 shadow-sm">
          <div className="px-4 sm:px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              {/* Hamburger visibile solo su mobile quando sidebar è chiusa */}
              <button
